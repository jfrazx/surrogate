...
export const NextFor = <T extends object>(nextOptions: NextForOptions) => {
...
export const NextPre = <T extends object>(nextOptions: NextHookOptions) => {
  return NextFor<T>({ ...nextOptions, type: PRE_HOOK });
};
export const NextPost = <T extends object>(nextOptions: NextHookOptions) => {
